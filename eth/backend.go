...
import (
	...
	"github.com/iswallet/go-ethereum/core/state/pruner"
	...
	"github.com/iswallet/go-ethereum/internal/shutdowncheck"
...
func New(stack *node.Node, config *ethconfig.Config, l1Client sync_service.EthClient) (*Ethereum, error) {
	...
	eth.syncService, err = sync_service.NewSyncService(context.Background(), eth.blockchain.Config(), stack.Config(), eth.chainDb, l1Client)
	if err != nil {
